...
public class Main_1451_G4_직사각형으로나누기_강이규 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long max = 0;
        // case 1 : 세로
        for (int c1 = 1, end1 = M-2; c1 <= end1; c1++) {
            for (int c2 = c1 + 1, end2 = M - 1; c2 <= end2; c2++) {
        ...
        // case 2 : 가로
        for (int r1 = 1, end1 = N-2; r1 <= end1; r1++) {
            for (int r2 = r1+1, end2 = N-1; r2 <= end2; r2++) {
        ...
        for (int c = 1, end1 = M-1; c <= end1; c++) {
            for (int r = 1, end2 = N-1; r <= end2; r++) {
                // case 3 : |=
